...
(function () {
  ...
  var I18N = {
    nl: {
      ...
      svcShortIntro: 'Finsera werkt in twee fasen: eerst bouwen we financiële inzichtelijkheid met managementrapportages en dashboards, daarna automatiseren we gericht met AI. Die volgorde is bewust — automatiseren op een wankel datafundament maakt problemen alleen maar sneller.',
      ...
      svc1Short: 'Een managementrapportage geeft de directie periodiek en betrouwbaar inzicht in omzet, marge, cashflow en KPI’s, zodat beslissingen op cijfers rusten in plaats van op onderbuikgevoel. Finsera bouwt daarvoor een datalaag op maat die pakketten als Exact Online en SnelStart ontsluit naar Power BI: van losse exports en Excel-lijsten naar één betrouwbare bron van waarheid.',
      svc2Short: 'AI-automatisering in finance betekent dat repetitieve administratieve workflows — verwerken, controleren, signaleren — door software worden uitgevoerd, met menselijk toezicht op de uitzonderingen. Finsera start met procesanalyse en -documentatie (AO/IC): pas als het fundament staat en processen zijn geborgd, automatiseren we gericht. Zo verdwijnt handwerk zonder dat je grip verliest.',
      ...
      svcC1B1: 'Datalaag op maat, herbruikbaar en schaalbaar',
      svcC1B2: 'Power BI-dashboards, afgestemd op hoe jouw MT stuurt',
      svcC1B3: 'KPI-framework: de cijfers die er echt toe doen',
      svcC1B4: 'Verankering in je maand- en MT-ritme',
      svcC1Hint: 'Startpunt',
      svcC2Meta: 'AI & automatisering', svcC2Phase: 'Fase 2 · doorlopend',
      svcC2TitleA: 'AI-strategie', svcC2TitleB: '& gerichte automatisering',
      svcC2B1: 'Procesanalyse en -documentatie (AO/IC)',
      svcC2B2: 'AI-agents op maat voor repetitieve workflows',
      svcC2B3: 'Automatische signalering en alerts op afwijkingen',
      svcC2B4: 'Menselijk toezicht ingebouwd — jij houdt de controle',
      ...
      heroSub: 'Finsera helpt snelgroeiende MKB-bedrijven aan betrouwbare stuurinformatie: managementrapportages en Power BI-dashboards op één solide datafundament, en gerichte AI-automatisering van financiële processen.',
      heroSubLead: 'Zodat jij beslist op basis van actuele cijfers — niet op gevoel.',
      ...
      diagBodyMore: 'Elke samenwerking start met een diagnose van je financiële processen, systemen en rapportages. Geen lange theoretische audit, maar een scherpe analyse met direct toepasbare aanbevelingen — zodat je waarde ziet vóórdat je aan een groter traject begint.',
      diagReadMore: 'Meer lezen', diagReadLess: 'Minder lezen',
      diagCheck1: 'Doorlooptijd 2–4 weken', diagCheck2: 'Scope en verwachtingen vooraf vastgelegd', diagCheck3: 'Concrete quick wins én prioriteiten voor de lange termijn', diagCheck4: 'Direct toepasbaar, ook als je zelf verder wilt',
      ...
      teamTitleB: 'jouw bedrijf financieel gezonder maken.',
      teamIntro1: 'Finsera is een boutique consultancybureau voor financiële procesoptimalisatie, opgericht door Öner Yücel. Samen met Tomas van der Laan, vanaf het eerste uur bij Finsera betrokken, combineren we senior financiële expertise met hands-on data- en softwareontwikkeling — bewust klein, zonder tussenlagen of junior consultants. Je spreekt altijd direct met de mensen die het werk doen.',
      ...
      painData: [
        ...
        ['Stuurinformatie komt te laat.', 'De maandafsluiting duurt weken. Tegen de tijd dat het rapport er ligt, is de informatie al verouderd.'],
        ['Te veel Excel, handwerk en hoofden.', 'Cruciale kennis zit bij één of twee personen. Valt er iemand uit, dan valt je rapportage stil.'],
    ...
    en: {
      ...
      svcShortIntro: 'Finsera works in two phases: first we build financial visibility with management reporting and dashboards, then we automate selectively with AI. That order is deliberate — automating on a shaky data foundation only makes problems arrive faster.',
      ...
      svc1Short: 'Management reporting gives the board periodic, reliable insight into revenue, margin, cash flow and KPIs, so decisions rest on figures rather than gut feeling. Finsera builds a bespoke data layer for that, unlocking packages such as Exact Online and SnelStart into Power BI: from loose exports and Excel lists to one reliable source of truth.',
      svc2Short: 'AI automation in finance means repetitive administrative workflows — processing, checking, flagging — are carried out by software, with human oversight on the exceptions. Finsera starts with process analysis and documentation (internal control): only once the foundation holds and processes are secured do we automate selectively. Manual work disappears without you losing control.',
      ...
      svcC1B1: 'A bespoke data layer, reusable and scalable',
      svcC1B2: 'Power BI dashboards, matched to how your board steers',
      svcC1B3: 'A KPI framework: the figures that actually matter',
      svcC1B4: 'Anchored in your monthly and board rhythm',
      ...
      svcC2B1: 'Process analysis and documentation (internal control)',
      svcC2B2: 'Bespoke AI agents for repetitive workflows',
      svcC2B3: 'Automatic flagging and alerts on deviations',
      svcC2B4: 'Human oversight built in — you stay in control',
      ...
      heroSub: 'Finsera gives fast-growing mid-market companies reliable steering information: management reporting and Power BI dashboards on one solid data foundation, plus targeted AI automation of financial processes.',
      heroSubLead: 'So you decide on current figures — not on gut feeling.',
      ...
      diagBenefit: 'A concrete plan for an immediate grip',
      ...
      diagBodyMore: 'Every engagement starts with a diagnosis of your financial processes, systems and reporting. Not a long theoretical audit, but a sharp analysis with directly applicable recommendations — so you see value before committing to anything larger.',
      diagReadMore: 'Read more', diagReadLess: 'Read less',
      diagCheck1: 'Two to four weeks', diagCheck2: 'Scope and expectations agreed upfront', diagCheck3: 'Concrete quick wins and long-term priorities', diagCheck4: 'Ready to apply, also if you continue on your own',
      ...
      teamTitleB: 'a financially healthier business for you.',
      teamIntro1: 'Finsera is a boutique consultancy for financial process optimisation, founded by Öner Yücel. Together with Tomas van der Laan, involved from the very first day, we combine senior financial expertise with hands-on data and software development — deliberately small, with no layers in between and no junior consultants. You always speak directly to the people doing the work.',
      ...
      painData: [
        ...
        ['Steering information arrives too late.', 'The monthly close takes weeks. By the time the report is ready, the information is already out of date.'],
        ['Too much Excel, manual work and heads.', 'Crucial knowledge sits with one or two people. If someone drops out, your reporting stops.'],
