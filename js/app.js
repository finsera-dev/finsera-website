...
(function () {
  ...
  var I18N = {
    nl: {
      ...
      faqEyebrow: 'Veelgestelde vragen', faqHeading: 'Wat vaak eerst gevraagd wordt.',
      faqQ1: 'Voor welk soort bedrijven werken jullie?',
      faqA1: 'MKB tussen 10 en 50 medewerkers, in vrijwel iedere sector. De rode draad is dat het bedrijf uit de improviseerfase groeit en toe is aan grip: één plek waar de cijfers kloppen en waar het MT op stuurt.',
      faqQ2: 'Hoe snel staat er iets bruikbaars?',
      faqA2: 'Meestal binnen 4 tot 6 weken na de diagnose. We werken in korte sprints met wekelijkse demo’s, dus je ziet elke week wat erbij komt — geen half jaar wachten op één oplevering.',
      faqQ3: 'Vervangen jullie onze controller of accountant?',
      faqA3: 'Nee, we versterken ze. We zorgen dat de data en de processen eronder kloppen, zodat je bestaande finance-team weer strategisch kan werken in plaats van fouten te zoeken.',
      faqQ4: 'Werken jullie met vaste of losse tarieven?',
      faqA4: 'Een vaste projectprijs voor de bouwfase, zodat er geen verrassingen zijn. Daarna een licht doorlopend abonnement voor onderhoud en sparring, opzegbaar per maand.',
      faqQ5: 'Waar draaien de dashboards?',
      faqA5: 'Meestal in Power BI of een lichte omgeving op maat in Azure. De data blijft bij jou; wij bouwen de laag ertussen, AVG-conform en met heldere documentatie.',
    ...
    en: {
      ...
      faqEyebrow: 'Frequently asked questions', faqHeading: 'What people ask first.',
      faqQ1: 'What kind of companies do you work for?',
      faqA1: 'Mid-sized companies between 10 and 50 employees, in almost any sector. The common thread is that the company is outgrowing the improvising phase and is ready for a grip: one place where the numbers hold and where management steers on them.',
      faqQ2: 'How quickly is something usable in place?',
      faqA2: 'Usually within 4 to 6 weeks after the diagnosis. We work in short sprints with weekly demos, so you see what has been added every week — no waiting half a year for a single delivery.',
      faqQ3: 'Do you replace our controller or accountant?',
      faqA3: 'No, we strengthen them. We make sure the data and the processes underneath hold, so your existing finance team can work strategically again instead of hunting for errors.',
      faqQ4: 'Do you work with fixed or variable rates?',
      faqA4: 'A fixed project price for the build phase, so there are no surprises. After that a light ongoing subscription for maintenance and sparring, cancellable monthly.',
      faqQ5: 'Where do the dashboards run?',
      faqA5: 'Usually in Power BI or a light bespoke environment on Azure. The data stays with you; we build the layer in between, GDPR-compliant and with clear documentation.',
