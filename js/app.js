...
(function () {
  ...
  var I18N = {
    nl: {
      ...
      dienstenPageEyebrow: 'Onze diensten', dienstenPageTitle: 'Grip op je groei: strategie, dashboards en AI.',
      dienstenPageIntro: 'Eén scherpe diagnose als startpunt, gevolgd door oplossingen die op elkaar voortbouwen. Hieronder ontdek je precies hoe wij financiële theorie omzetten in keiharde praktijk.',
      routeSectionEyebrow: 'Onze aanpak', routeSectionTitle: 'Drie logische stappen voor maximaal resultaat.',
      ...
      aanpakIntro: 'Elk traject start met een grondige nulmeting. Wat we daarna bouwen, hangt volledig af van de doelstellingen van jouw directie. We automatiseren processen overigens pas als het datateam en het financiële fundament waterdicht zijn. Hieronder lees je wat je van elke fase mag verwachten.',
      ...
      dgnIntro: 'Elke samenwerking begint hier. In twee tot vier weken lichten we je bedrijfsdoelen, financiële processen en het complete IT-landschap door. Verwacht van ons geen lange theoretische audit, maar een scherpe analyse met aanbevelingen die je direct kunt uitvoeren. Zo ervaar je onze waarde nog vóórdat we beslissen over een groter vervolgtraject.',
      dgnColA: 'Wat we doorlichten',
      dgnColB: 'Wat je krijgt',
      dgnA1b: 'Je strategie en sturing:',
      dgnA1: 'wat is het doel en sluit je huidige begroting hier naadloos op aan?',
      dgnA2b: 'De processen eromheen:',
      dgnA2: 'van eerste inkooporder tot maandafsluiting, inclusief al het verborgen handwerk.',
      dgnA3b: 'Je systemen en datastromen:',
      dgnA3: 'welke bronnen zijn er, hoe communiceren ze en waar valt de data stil?',
      dgnA4b: 'De vastlegging (AO/IC):',
      dgnA4: 'wie tekent waarvoor en staat dit interne raamwerk bij een externe controle overeind?',
      dgnB1b: 'Een strategisch adviesrapport:',
      dgnB1: 'de huidige situatie naast de gewenste structuur, inclusief een heldere businesscase.',
      dgnB2b: 'Directe quick wins:',
      dgnB2: 'verbeteringen die je binnen een paar weken zelf kunt doorvoeren.',
      dgnB3b: 'Prioriteiten voor de lange termijn:',
      dgnB3: 'een logische roadmap die de operatie niet verstoort.',
      dgnB4b: 'Een vaste projectprijs',
      dgnB4: 'voor het vervolg, gebaseerd op feiten in plaats van een ruwe schatting vooraf.',
      dgnF1: 'Doorlooptijd',
      dgnV1: '2 tot 4 weken',
      dgnF2: 'Vorm',
      ...
      dfaqQ1: 'Wat kost het?',
      dfaqA1: 'Projecten voeren we uit tegen een vaste projectprijs, vooraf afgesproken op basis van de feiten uit de diagnose. Voor doorlopend beheer en de doorontwikkeling van dashboards werken we met een overzichtelijk abonnement. Veelal kost het traject tussen de €5.000 en €15.000, maar omdat elk traject absoluut maatwerk is, noemen we pas een exacte investering als we de scope helder hebben.',
      dfaqQ2: 'Hoe lang duurt het?',
      dfaqA2: 'De diagnose duurt twee tot vier weken. Daarna staat er meestal binnen vier tot zes weken een eerste werkend dashboard of systeem. We werken met wekelijkse demo’s. Zo zie je tussentijds precies wat we bouwen en kun je direct bijsturen.',
      dfaqQ3: 'We hebben al een dashboard. Wat dan?',
      dfaqA3: 'Dan beginnen we exact op dat punt. Vaak ontbreekt niet het dashboard zelf, maar de betrouwbare datalaag eronder. Of juist andersom. We bouwen slim voort op wat er al staat en herstellen wat niet klopt, in plaats van onnodig alles opnieuw te bouwen.',
      dfaqQ4: 'Vervangen jullie onze boekhouder of controller?',
      dfaqA4: 'Nee. We vervangen geen bestaande functies, we versterken ze. Je administratie blijft precies waar die is. Wij zorgen er alleen voor dat de data daaruit razendsnel doorstroomt naar bruikbare stuurinformatie. Heb je door groei tijdelijk senior financiële sturing nodig? Dan bieden we wel aanvullende interim controller services op afstand.',
      dfaqQ5: 'Van wie is wat jullie bouwen?',
      dfaqA5: 'Alles is van jou. We bouwen uitsluitend op Power BI en Microsoft Azure, bij voorkeur binnen je eigen licenties en IT-omgeving. Wij doen niet aan vendor lock-in. Alles wat we opleveren is van jouw bedrijf en wordt netjes gedocumenteerd, zodat je er altijd onafhankelijk mee verder kunt.',
      dfaqQ6: 'Moeten we met alle drie de diensten beginnen?',
      dfaqA6: 'Absoluut niet. De diagnose is een afgerond en zelfstandig product. Veel klanten focussen zich daarna eerst uitsluitend op de rapportages. Automatiseren heeft namelijk pas zin als het fundament klopt. Anders escaleren onderliggende problemen alleen maar sneller.',
      ...
      svc1Intro: 'We vertalen jouw strategie naar een helder normenkader en concrete stuurgetallen. Pas daarna maken we de overstap van losse Excel-lijsten naar één centrale database. We brengen financiële én operationele data samen en geven er betekenis aan. Hierdoor kijken finance, directie en operatie eindelijk naar exact dezelfde feiten. Je ziet in één oogopslag waar je op koers ligt en waar je direct moet bijsturen.',
      ...
      svc2Title: 'AI-strategie & gerichte automatisering', svc2Benefit: 'Slagkracht door slimme technologie',
      svc2IntroShort: 'Goede automatisering begint nooit bij een stukje software, maar altijd bij je processen. Omdat we deze tijdens de diagnose al hebben doorgrond, zien we exact waar AI de hoogste waarde toevoegt.',
      svc2IntroMore: 'We focussen op het automatiseren van repeterend handwerk binnen finance en de operatie. Hierdoor houdt je team tijd over voor analyse en strategisch advies. Geen wilde experimenten, maar doordachte, veilige toepassingen met scherp oog voor privacy en ingebouwd menselijk toezicht.',
      ...
      casesEyebrow: 'Cases', casesTitle: 'Onze impact in de praktijk', casesRead: 'Bekijk deze case',
      revIntro: 'Finsera bouwt datafundamenten en stroomlijnt processen voor uiteenlopende sectoren, met een sterke focus op e-commerce en de zorg. Twee voorbeelden van wat strategische inzichtelijkheid in de dagelijkse praktijk oplevert.',
      revResultLabel: 'Resultaat', revNote: 'Resultaten uit de eigen omgeving van de klant',
      revAll: 'Bekijk alle cases',
      faqEyebrow: 'Veelgestelde vragen', faqHeading: 'Veelgestelde vragen',
      faqIntro: 'Heldere antwoorden op vragen die we vaak krijgen van directies en financials. Staat je vraag er niet bij?', faqIntroCta: 'Plan dan gerust een vrijblijvende kennismaking',
      faqQ1: 'Voor welk type bedrijven is Finsera de juiste partner?',
      faqA1: 'Finsera werkt voor snelgroeiende MKB- en mid-market bedrijven met circa 10 tot 50 medewerkers. Dit zijn bedrijven die de pioniersfase voorbij zijn en serieuze omzetten draaien, maar merken dat hun huidige systemen de volgende groeifase blokkeren. We hebben diepgaande ervaring in onder andere e-commerce en de zorg. Onze ideale klant heeft een directie die de regie wil pakken en actief wil sturen op data, in plaats van op gevoel.',
      faqQ2: 'Hoe snel hebben we een werkend dashboard of systeem draaien?',
      faqA2: 'Na onze initiële diagnose van 2 tot 4 weken leveren we meestal binnen 4 tot 6 weken de eerste bruikbare systemen op. Wij geloven absoluut niet in IT-trajecten die maanden duren zonder dat de directie resultaat ziet. We werken met wekelijkse demo’s. Je ziet direct wat we bouwen, je kunt tussentijds bijsturen en we houden het tempo erin. Snelheid en strategische precisie gaan bij ons hand in hand.',
      faqQ3: 'Vervangt Finsera onze eigen controller of financiële administratie?',
      faqA3: 'Nee, absoluut niet. Wij zijn er niet om jouw financiële afdeling te vervangen, maar om ze een structurele upgrade te geven. Jouw administratie blijft gewoon doordraaien. Wij bouwen de technische laag eroverheen die al dat handwerk omzet in strategische stuurinformatie. Heb je door groei of uitval tijdelijk extra denkkracht nodig? Dan bieden we wel aanvullende interim controller services op afstand om de continuïteit te borgen.',
      faqQ4: 'Hoe is jullie prijsmodel opgebouwd?',
      faqA4: 'We werken niet met onverwachte verrassingen achteraf of eindeloos uurtje-factuurtje. Voor de bouw van je datastructuur en dashboards spreken we na de diagnose een vaste projectprijs af. Voor het doorlopende beheer, de beveiliging en verdere optimalisaties werken we met een overzichtelijk maandelijks abonnement. Omdat geen enkel bedrijf of softwarelandschap hetzelfde is, bepalen we de exacte investering altijd in overleg tijdens onze eerste gesprekken.',
      faqQ5: 'Waar staat onze data en wie is de eigenaar?',
      faqA5: 'Jouw data is en blijft 100% van jou. Wij koppelen al je softwarepakketten aan één centrale database, die we bij voorkeur veilig binnen jullie eigen (Microsoft) bedrijfsomgeving inrichten. Wij doen niet aan vendor lock-in. Dit betekent dat je niet afhankelijk wordt van onze systemen. Mocht de samenwerking ooit stoppen, dan behoud jij de volledige toegang tot al je data en de gebouwde dashboards. Dat vinden wij de enige transparante manier van zakendoen.',
      ...
      case2StatA: 'Van achteraf verantwoorden naar', case2StatB: 'aantoonbaar in control',
      // Vul deze pas met een citaat dat de klant zelf heeft goedgekeurd en
      // haal dan [hidden] van het blockquote in index.html weg.
      review1Quote: '“Als snelgroeiend bedrijf ontgroeiden we de standaard rapportages. We wilden niet langer alleen de totale omzet zien, maar op detailniveau weten hoe de marges per productgroep presteren. Tomas en Öner hebben ons enorm geholpen door de ruwe data uit al onze systemen voor verkoop, voorraad en financiën slim aan elkaar te koppelen. In ons nieuwe Power BI-dashboard hebben we nu real-time inzicht in de juiste stuurgetallen. Het geeft ons als directie precies de data en de bevestiging die we nodig hebben om vol vertrouwen verder te schalen.”', review2Quote: '“In de zorgsector zijn de eisen rondom compliance en verantwoording onverminderd hoog. Om de snelle ontwikkeling van onze organisatie in goede banen te leiden, wilden we proactief sturen in plaats van achteraf verantwoorden. Öner heeft de professionaliseringsslag van onze administratieve organisatie en interne beheersing (AO/IC) uitstekend begeleid. Hij bracht de benodigde structuur aan in onze processen. We zijn nu op elk moment aantoonbaar ‘in control’. Dat zorgt voor enorm veel rust binnen de organisatie, zeker met het oog op externe audits.”',
      case1Tag: 'E-commerce', case1Title: 'Van sturen op omzet naar sturen op marge.',
      case1Chip1: 'Webshop', case1Chip2: 'Marketing', case1Chip3: 'Boekhouding', case1ChartLabel: 'Marge per merk',
      case2Tag: 'Zorg', case2Title: 'Van achteraf constateren naar aantoonbaar in control.',
      ...
      ctaTitle: 'Klaar om de regie over je bedrijfsvoering te pakken?',
      ctaText: 'Geen tijdelijke pleisters of losse tools, maar een strategisch fundament dat met je organisatie meegroeit. Laten we in één gesprek verkennen waar de processen nu vastlopen en waar voor jullie de grootste winst zit.',
    ...
    en: {
      ...
      dienstenPageEyebrow: 'Our services', dienstenPageTitle: 'A grip on your growth: strategy, dashboards and AI.',
      dienstenPageIntro: 'One sharp diagnosis as the starting point, followed by solutions that build on each other. Below you will find exactly how we turn financial theory into hard practice.',
      routeSectionEyebrow: 'Our approach', routeSectionTitle: 'Three logical steps for maximum result.',
      ...
      aanpakIntro: 'Every engagement starts with a thorough baseline measurement. What we build after that depends entirely on your management team’s objectives. We only automate processes once the data layer and the financial foundation are watertight. Below you can read what to expect from each phase.',
      ...
      dgnIntro: 'Every engagement starts here. In two to four weeks we review your business goals, financial processes and the complete IT landscape. Do not expect a long theoretical audit, but a sharp analysis with recommendations you can act on straight away. That way you experience our value before we decide on anything larger.',
      dgnColA: 'What we examine',
      dgnColB: 'What you get',
      dgnA1b: 'Your strategy and steering:',
      dgnA1: 'what is the goal, and does your current budget line up with it seamlessly?',
      dgnA2b: 'The processes around them:',
      dgnA2: 'from the first purchase order to the month-end close, including all the hidden manual work.',
      dgnA3b: 'Your systems and data flows:',
      dgnA3: 'which sources exist, how do they communicate and where does the data stall?',
      dgnA4b: 'The documentation (internal control):',
      dgnA4: 'who signs off on what, and does that internal framework hold up in an external audit?',
      dgnB1b: 'A strategic advisory report:',
      dgnB1: 'the current situation beside the desired structure, including a clear business case.',
      dgnB2b: 'Immediate quick wins:',
      dgnB2: 'improvements you can implement yourself within a few weeks.',
      dgnB3b: 'Long-term priorities:',
      dgnB3: 'a logical roadmap that does not disrupt operations.',
      dgnB4b: 'A fixed project price',
      dgnB4: 'for the next step, based on facts instead of a rough estimate upfront.',
      dgnF1: 'Lead time',
      dgnV1: '2 to 4 weeks',
      dgnF2: 'Format',
      ...
      dfaqA1: 'We carry out projects for a fixed project price, agreed in advance on the basis of the facts from the diagnosis. For ongoing management and further development of dashboards we work with a clear subscription. A track usually costs between €5,000 and €15,000, but because every engagement is genuinely tailored, we only name an exact investment once the scope is clear.',
      dfaqQ2: 'How long does it take?',
      dfaqA2: 'The diagnosis takes two to four weeks. After that, a first working dashboard or system is usually in place within four to six weeks. We work with weekly demos, so you see exactly what we are building along the way and can adjust immediately.',
      dfaqQ3: 'We already have a dashboard. What then?',
      dfaqA3: 'Then we start exactly there. Often it is not the dashboard that is missing, but the reliable data layer underneath it. Or the other way round. We build smartly on what is already there and repair what is wrong, instead of needlessly rebuilding everything.',
      dfaqQ4: 'Do you replace our bookkeeper or controller?',
      dfaqA4: 'No. We do not replace existing roles, we strengthen them. Your administration stays exactly where it is. We simply make sure the data flows out of it rapidly into usable steering information. Do you temporarily need senior financial steering because of growth? Then we do offer additional remote interim controller services.',
      dfaqQ5: 'Who owns what you build?',
      dfaqA5: 'Everything is yours. We build exclusively on Power BI and Microsoft Azure, preferably within your own licences and IT environment. We do not do vendor lock-in. Everything we deliver belongs to your company and is properly documented, so you can always continue independently.',
      dfaqQ6: 'Do we have to start with all three services?',
      dfaqA6: 'Absolutely not. The diagnosis is a complete, standalone product. Many clients then focus purely on the reporting first. Automating only makes sense once the foundation is right; otherwise underlying problems only escalate faster.',
      ...
      svc1Intro: 'We translate your strategy into a clear set of norms and concrete steering figures. Only then do we make the move from loose Excel lists to one central database. We bring financial and operational data together and give it meaning, so finance, management and operations finally look at exactly the same facts. You see at a glance where you are on course and where you need to adjust.',
      ...
      svc2Title: 'AI strategy & targeted automation', svc2Benefit: 'Momentum through smart technology',
      svc2IntroShort: 'Good automation never starts with a piece of software, but always with your processes. Because we already got to the bottom of those during the diagnosis, we see exactly where AI adds the most value.',
      svc2IntroMore: 'We focus on automating repetitive manual work within finance and operations. That leaves your team time for analysis and strategic advice. No wild experiments, but considered, safe applications with a sharp eye for privacy and human oversight built in.',
      ...
      casesEyebrow: 'Cases', casesTitle: 'Our impact in practice', casesRead: 'View this case',
      revIntro: 'Finsera builds data foundations and streamlines processes across a range of sectors, with a strong focus on e-commerce and healthcare. Two examples of what strategic visibility delivers in daily practice.',
      revResultLabel: 'Result', revNote: 'Results from the client’s own environment',
      revAll: 'View all cases',
      faqEyebrow: 'Frequently asked questions', faqHeading: 'Frequently asked questions',
      faqIntro: 'Clear answers to the questions we often get from management teams and finance professionals. Is your question not here?', faqIntroCta: 'Feel free to book an intro call',
      faqQ1: 'What kind of companies is Finsera the right partner for?',
      faqA1: 'Finsera works for fast-growing SME and mid-market companies of roughly 10 to 50 employees. These are companies past the pioneering phase, with serious revenue, that notice their current systems are blocking the next stage of growth. We have deep experience in e-commerce and healthcare, among others. Our ideal client has a management team that wants to take charge and steer actively on data instead of on gut feeling.',
      faqQ2: 'How quickly do we have a working dashboard or system running?',
      faqA2: 'After our initial two- to four-week diagnosis, we usually deliver the first usable systems within four to six weeks. We absolutely do not believe in IT projects that drag on for months without management seeing any result. We work with weekly demos. You see straight away what we are building, you can adjust along the way, and we keep up the pace. Speed and strategic precision go hand in hand here.',
      faqQ3: 'Does Finsera replace our own controller or financial administration?',
      faqA3: 'No, absolutely not. We are not here to replace your finance department but to give it a structural upgrade. Your administration simply keeps running. We build the technical layer on top of it that turns all that manual work into strategic steering information. Do you temporarily need extra thinking power because of growth or absence? Then we do offer additional remote interim controller services to safeguard continuity.',
      faqQ4: 'How is your pricing model built up?',
      faqA4: 'We do not work with unexpected surprises afterwards or endless hourly billing. For building your data structure and dashboards we agree a fixed project price after the diagnosis. For ongoing management, security and further optimisation we work with a clear monthly subscription. Because no company or software landscape is the same, we always determine the exact investment together during our first conversations.',
      faqQ5: 'Where does our data live and who owns it?',
      faqA5: 'Your data is and remains 100% yours. We connect all your software packages to one central database, which we prefer to set up securely inside your own (Microsoft) environment. We do not do vendor lock-in. That means you do not become dependent on our systems. Should the collaboration ever end, you keep full access to all your data and to the dashboards we built. We consider that the only transparent way of doing business.',
      ...
      case2Person: 'Miriam Twilt-Mendonça',
      case2StatA: 'From accounting for it afterwards to', case2StatB: 'demonstrably in control',
      review1Quote: '“As a fast-growing company we outgrew the standard reports. We no longer wanted to see only total revenue, but to know in detail how margins per product group were performing. Tomas and Öner helped us enormously by cleverly connecting the raw data from all our systems for sales, stock and finance. In our new Power BI dashboard we now have real-time insight into the right steering figures. As a management team it gives us exactly the data and the confirmation we need to keep scaling with confidence.”', review2Quote: '“In healthcare the demands around compliance and accountability remain high. To guide the rapid development of our organisation, we wanted to steer proactively instead of accounting for things afterwards. Öner guided the professionalisation of our administrative organisation and internal control excellently. He brought the structure our processes needed. We are now demonstrably ‘in control’ at any moment. That brings an enormous amount of calm to the organisation, certainly with external audits in mind.”',
      case1Tag: 'E-commerce', case1Title: 'From steering on revenue to steering on margin.',
      case1Chip1: 'Webshop', case1Chip2: 'Marketing', case1Chip3: 'Bookkeeping', case1ChartLabel: 'Margin per brand',
      case2Tag: 'Healthcare', case2Title: 'From finding out afterwards to demonstrably in control.',
      ...
      ctaTitle: 'Ready to take charge of your operation?',
      ctaText: 'No temporary patches or loose tools, but a strategic foundation that grows with your organisation. Let us explore in one conversation where the processes are stuck today and where your biggest gain lies.',
