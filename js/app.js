...
(function () {
  ...
  var I18N = {
    nl: {
      ...
      review1Quote: 'Als snelgroeiend bedrijf ontgroeiden we de standaard rapportages. We wilden niet langer alleen de totale omzet zien, maar op detailniveau weten hoe de marges per productgroep presteren. Finsera heeft ons enorm geholpen door de ruwe data uit al onze systemen voor verkoop, voorraad en financiën slim aan elkaar te koppelen. In ons nieuwe Power BI-dashboard hebben we nu real-time inzicht in de juiste stuurgetallen. Het geeft ons als directie precies de data en de bevestiging die we nodig hebben om vol vertrouwen verder te schalen.', review2Quote: 'In de zorgsector zijn de eisen rondom compliance en verantwoording onverminderd hoog. Om de snelle ontwikkeling van onze organisatie in goede banen te leiden, wilden we proactief sturen in plaats van achteraf verantwoorden. Finsera heeft de professionaliseringsslag van onze administratieve organisatie en interne beheersing (AO/IC) uitstekend begeleid. Ze brachten de benodigde structuur aan in onze processen. We zijn nu op elk moment aantoonbaar ‘in control’. Dat zorgt voor enorm veel rust binnen de organisatie, zeker met het oog op externe audits.',
