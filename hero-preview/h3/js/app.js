...
(function () {
  ...
  var I18N = {
    nl: {
      ...
      dlBody: 'Verkoopdata in Excel, operatie in je ERP, financiële administratie in Exact — drie systemen, drie waarheden. Finsera bouwt de tussenlaag: één datalaag op maat, aangevuld met AI, die alles samenbrengt in het dashboard waar jij écht op kunt sturen.',
      dlColA: 'Bronnen', dlColB: 'Finsera · AI', dlColC: 'Eén dashboard',
      dlSrc1: 'verkoop · sheets', dlSrc2: 'operatie · voorraad', dlSrc3: 'financiële adm.',
      dlCore: 'datalaag op maat', dlMonth: 'Augustus · overzicht',
      dlK1: 'Omzet MTD', dlK2: 'Brutomarge', dlK3: 'Cashpositie',
      dlChart: 'Omzet vs. begroting', dlFootA: '3 bronnen', dlFootB: '1 dashboard',
      factEmpCap: 'medewerkers', factRevCap: 'omzet', factCallCap: 'vrijblijvende discovery call',
    ...
    en: {
      ...
      dlBody: 'Sales data in Excel, operations in your ERP, financial administration in Exact — three systems, three versions of the truth. Finsera builds the layer in between: one bespoke data layer, augmented with AI, that brings everything together in the dashboard you can actually steer by.',
      dlColA: 'Sources', dlColB: 'Finsera · AI', dlColC: 'One dashboard',
      dlSrc1: 'sales · sheets', dlSrc2: 'operations · stock', dlSrc3: 'financial adm.',
      dlCore: 'bespoke data layer', dlMonth: 'August · overview',
      dlK1: 'Revenue MTD', dlK2: 'Gross margin', dlK3: 'Cash position',
      dlChart: 'Revenue vs. budget', dlFootA: '3 sources', dlFootB: '1 dashboard',
      factEmpCap: 'employees', factRevCap: 'revenue', factCallCap: 'no-obligation discovery call',
